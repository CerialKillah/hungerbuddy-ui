  ...
  return (
    <div className={style.mainbox}>
      <div className={style.box}>
        <div className={style.leftone}>Hungerbuddy</div>
      ...
      <div className={style.last}>
        <div className={style.lasttext}>
          For better experience, download the Hungerbuddy app now
        </div>
        <div className={style.storeLinks}>
          <Link href="#" className={style.storeLink}>
            <img
